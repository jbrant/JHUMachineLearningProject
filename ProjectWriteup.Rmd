...
#download.file(training.url, "har-training.csv", mode = "wb")
#download.file(testing.url, "har-testing.csv", mode = "wb")

## Read in training data
training.data <- read.csv("har-training.csv", na.strings = c("", "NA"))

## Read in testing data
testing.data <- read.csv("har-testing.csv", na.strings = c("", "NA"))
```
